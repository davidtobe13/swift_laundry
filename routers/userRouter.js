...
router.get("/get-All-Completed-Orders/:userId",authenticate, getAllCompletedOrders)
...
router.post("/user-Silver-Plan",authenticate, userSilverPlan)
router.post("/user-Gold-Plan",authenticate, userGoldPlan)

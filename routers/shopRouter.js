...
router.put('/update-shop', upload.single("profileImage"),authenticate, updateShop)
router.get('/get-shop-orders', authenticate, getShopOrders)
...
router.get('/get-one-user/:id', authenticate, getOneUser)
...
router.post('/complete-order/:orderId', authenticate, updateOrderStatusToCompleted)

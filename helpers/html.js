const dynamicHtml=( link,name)=> {
                    ...
                    <tr>
                        <td>
                            <div style="padding: 0 2.5em; text-align: center; margin-bottom: 0px;">
                                ...
                                <h3 style="font-family: 'Lato', sans-serif; font-size: 22px; font-weight: 300;">Welcome On Board , ${name},<br/>Click the button below to verify your account.</h3>
                                <p><a href=${link} class="btn btn-primary" style="padding: 10px 30px; display: inline-block; border-radius: 3px;  margin-top:20px; background: #4DC6E1; color: #ffffff; text-decoration: none;">Verify</a></p>
  ...
  //                               <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">Welcome On Board , ${businessName},<br/>Click the button below to verify your account.</h3>
  //                               <p><a href=${link} class="btn btn-primary" style="padding: 15px 35px; display: inline-block; border-radius: 3px; background: #4DC6E1; color: #ffffff; text-decoration: none;">Verify</a></p>

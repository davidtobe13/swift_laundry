...
<body style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
    ...
    <div style="max-width: 600px; margin: 0 auto;">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto; display: flex; align-items: center; justify-content: center; flex-direction: column;">
          ...
          <td valign="middle" style="padding: 3em 0 2em 0;">
            <img src="https://res.cloudinary.com/dxodxmvdr/image/upload/v1709050377/wm8csyjqjzflkm9f5n29.png" alt="" style="width: 300px; max-width: 600px; height: auto; margin: auto; display: block;">
          </td>
          </tr><!-- end tr -->
                <tr>
                ...
                <tr>
                    <td>
                        <div style="padding: 0 2.5em; text-align: center; margin-bottom: 0px;">
                            <h2 style="font-family: 'Lato', sans-serif; color: rgba(0,0,0,.3); font-size: 30px; margin-bottom: 0; font-weight: 400;">Please reset your Password</h2>
                            <h3 style="font-family: 'Lato', sans-serif; font-size: 22px; font-weight: 300;"> ${name},<br/>Click the button below to reset your password.</h3>
                            <p><a href=${link} class="btn btn-primary" style="padding: 10px 30px; display: inline-block; border-radius: 3px;  margin-top:20px; background: #4DC6E1; color: #ffffff; text-decoration: none;">Reset Password</a></p>
      ...
      <span style="color: rgba(0,0,0,.5);">161/163 Muyibi street,Olodi Apapa</span><br>
       <span style="color: rgba(0,0,0,.5);">081372586756</span>
  ...
  //                             <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;"> ${name},<br/>Click the button below to reset your password.</h3>
